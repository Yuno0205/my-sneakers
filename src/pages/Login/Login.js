...
function Login() {
    const google = () => {
        window.open('https://jorkan-backend.vercel.app/auth/google', '_self');
    };

    const github = () => {
        window.open('https://jorkan-backend.vercel.app/auth/github', '_self');
    };

    const facebook = () => {
        window.open('https://jorkan-backend.vercel.app/auth/facebook', '_self');
    };
    return (
